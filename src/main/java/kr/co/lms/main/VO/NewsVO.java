...
public class NewsVO {
	...
	private String admin_notice_MM_date;
	private String admin_notice_DD_date;
	...
	public String getAdmin_notice_MM_date() {
		return admin_notice_MM_date;
	}
	public void setAdmin_notice_MM_date(String admin_notice_MM_date) {
		this.admin_notice_MM_date = admin_notice_MM_date;
	}
	public String getAdmin_notice_DD_date() {
		return admin_notice_DD_date;
	}
	public void setAdmin_notice_DD_date(String admin_notice_DD_date) {
		this.admin_notice_DD_date = admin_notice_DD_date;
	}
