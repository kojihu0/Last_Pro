			...
			<table>
				<tbody>  
					<tr>  
						...
						<td class="p-3 border border-black" style="width:800px"><input class="border border-black" type="text" id="teacherName" name="teacherName"/></td>  
					</tr> 
					<tr> 
					...
					<tr> 
						...
						<td class="p-3 border border-black"><input class="border border-black" type="text" id="teacherId" name="teacherId" placeholder="teacher@email.com == id"/></td>  
					</tr>
					<tr>
