...
<body>
	...
	<div class="w-full max-w-screen-xl my-0 mx-auto items-center justify-between flex-wrap px-8 xl:px-0">
		...
		<div class="p-3 flex justify-center">
			<form method="post" action="/lms/admin/adminCourseEditOk" onsubmit="return checkRegCourseEdit()"> 
				<table>
					<thead> 
						<tr>
						...
						<tr>
							...
							<td class="p-3 calendar"><input class="datepicker border border-gray-600"type="text" name="courseStart" id="courseStart" value=""/></td>
						</tr>
						<tr>
							<th class="bg-info-300 p-3 w-32">담당</th>
							<td class="p-3"><input type="text" name="teacherNmae" id="teacherName" placeholder="김아무개"/></td>
						</tr>
						<tr> 
							<th class="bg-info-300 p-3 w-32">수강료</th>
							<td class="p-3"><input type="text" name="coursePrice" id="coursePrice" placeholder="360000" size="7"  onkeyup="inputNumberFormat(this)"/></td>
						</tr>
						<tr>
							<th class="bg-info-300 p-3 w-32">접수 기간</th>
							<td class="p-3  calendar">
								<input class="datepicker border border-gray-600" type="text" name="startRegiDate" id="startRegiDate"/>&nbsp;~&nbsp;<input class="datepicker border border-gray-600" type="text" name="endRegiDate" id="endRegiDate"/>
							</td>
						</tr>
						<tr>
							<th class="bg-info-300 p-3 w-32">수강기간</th>
							<td class="p-3 calendar">
								<input class="border border-gray-600 datepicker" type="text" name="startCourseDate" id="startCourseDate"/>&nbsp;~&nbsp;<input class="border border-gray-600 datepicker" type="text" name="endCourseDate" id="endCourseDate"/>
							</td>
						</tr>
						<tr>
							<th class="bg-info-300 p-3 w-32">상태</th>
							<td class="p-3">
								<input type="radio" name="courseState" value="개강" id="radioCheck_01" checked/>&nbsp;개 강&nbsp;
								<input type="radio" name="courseState" value="대기" id="radioCheck_02"/>&nbsp;대 기&nbsp;
								<input type="radio" name="courseState" value="폐강" id="radioCheck_03"/>&nbsp;폐 강&nbsp;
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="p-3">
								<textarea id="courseStory" class="border border-black" rows="7" cols="100" style="resize: none;" name="courseStory"></textarea>
							</td>
						</tr>
						<tr>
