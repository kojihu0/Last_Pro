	...
	<form method="post" action="/lms/admin/student_leaveOutOk" class="w-full my-3">
		...
		<table class="w-full">
			...
			<tr>
				...
				<td class="border border-solid border-gray-600 p-2">
					<div class="calendar">
						<input type="text" name="student_course_state_date" class="datepicker border-solid border border-gray-600 ml-2" id="leave_out_date"/>
					</div>
				</td>
			</tr>
			<tr>
		...
		<div class="text-center my-3 ">
			<input type="submit" value="처리하기" id="leave_outOk" class="border border-solid border-gray-600 rounded bg-info-200"/>
		</div>
	</form>
</div>
