...
<div class="w-full max-w-screen-xl my-0 mx-auto flex items-center justify-between flex-wrap px-8 xl:px-0">
	...
	<form class="w-full" method="post" action="/lms/modify_returnOk">
		...
		<table class="w-full">
			<tbody>
				<tr>
					<td class="border-solid border border-gray-600 text-center bg-info-200 p-2">개강년월</td>
					<td class="border-solid border border-gray-600 p-2">${vo.course_start_date}</td>
				</tr>
				<tr>
					<td class="border-solid border border-gray-600 text-center bg-info-200 p-2">강좌명</td>
					<td class="border-solid border border-gray-600 p-2">${vo.course_name}</td>
				</tr>
				<tr>
					<td class="border-solid border border-gray-600 text-center bg-info-200 p-2">수납액</td>
					<td class="border-solid border border-gray-600 p-2">${vo.payment_price}원(카드)</td>
				</tr>
				<tr>
					<td class="border-solid border border-gray-600 text-center bg-info-200 p-2">반환내역</td>
					<td class="border-solid border border-gray-600 p-2">
						<table>
							<tbody>
							<tr>
								<td class="p-2">반환액</td>
								<td class="p-2"><input type="text" class="border-solid border border-gray-600" name="refund_price" value="${vo.refund_price}"/>원</td>
							</tr>
							<tr>
								<td class="p-2">반환사유</td>
								<td class="p-2"><input type="text" class="border-solid border border-gray-600" name="refund_reason" value="${refund_reason}"/></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="p-2 calendar"><input type="text" class="datepicker border-solid border border-gray-600" name="refund_date" value="${vo.refund_date}"/></td>
							</tr>
							<tr>
								<td class="p-2">비고</td>
								<td class="p-2"><input type="text" class="border-solid border border-gray-600" value="${vo.refund_memo}" name="refund_memo"/></td>
							</tr>
							</tbody>
						</table>
					</td>
