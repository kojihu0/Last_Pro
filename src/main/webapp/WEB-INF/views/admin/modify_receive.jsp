	...
	<form class="w-full" method="post" action="/lms/modify_receiveOk"> 
		...
		<tbody>
			<tr>
				...
				<td class="border-solid border-2 border-gray-600 p-2">[${vo.payment_date}]${vo.course_name}</td>
			</tr>
			<tr>
				<td class="border-solid border-2 border-gray-600 text-center bg-info-200 p-2">수강정보</td>
						...
						<tbody>
							<tr>
								...
								<td class="p-2 calendar">
									<input type="text" class="datepicker border-solid border-2 border-gray-600 text-center" name="course_start_date" value="${vo.course_start_date}"/> ~
									<input type="text" class="datepicker border-solid border-2 border-gray-600 text-center" name="course_end_date" value="${vo.course_end_date}"/>
								</td>
							</tr>
							<tr>
								<td class="p-2">수강료</td>
								<td class="p-2"><input type="text" class="border-solid border-2 border-gray-600 text-center" name="course_price" value="${vo.course_price}"readonly/>원</td>
							</tr>
						</tbody>
					</table>
				</td>
				...
				<td class="border-solid border-2 border-gray-600 text-center p-2">
					<table>
						<tbody>
							<tr>
								<td class="p-2">수납액</td>
								<td class="p-2"><input type="text" name="payment_price" class="border-solid border-2 border-gray-600 text-center" value="${vo.payment_price}"/>원</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="p-2 calendar"><input type="text" class="datepicker border-solid border-2 border-gray-600 text-center" name="payment_date" value="${vo.payment_date}"/></td>
							</tr>
							<tr>
								<td class="p-2">비고</td>
								<td class="p-2"><input type="text" class="border-solid border-2 border-gray-600" name="payment_memo" value="${vo.payment_memo}"/></td>
							</tr>
						</tbody>
					</table>
				</td>
