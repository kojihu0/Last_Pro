		...
		<table class="w-full">
			<tr>
				...
				<td class="border-2 border-solid border-gray-600 p-2">
					<div class="inline-block relative w-30 mx-2">
							<select class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline transfer_class_year">
								<option>==</option>
						...
						<div class="inline-block relative w-20 mx-2">
							<select class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline transfer_class_month">
								<option>==</option>
							    <option>01</option>
							    <option>02</option>
							    <option>03</option>
						...
						<div class="inline-block relative w-40 mx-2">
							<select class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline transfer_class">
								<option>==</option>
							    <option>JAVA</option>
