		...
		<table class="w-full">
			...
			<tr>
				...
				<td class="border-solid border-2 border-gray-600 p-2 ">
					...
					년<div class="inline-block relative w-40 mx-2">
						<select name="student_birthday_month" class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline birthMonth">
							<option>선택</option>
					...
					월<div class="inline-block relative w-40 mx-2">
						<select name="student_birthday_day" class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline birthDay">
							<option>선택</option>
			...
			<tr>
				...
				<td  class="border-solid border-2 border-gray-600 p-2 "colspan="3">
					...
					<input type="text" name="student_addr_main" value="${vo.student_addr_main}" class="addr_main border-solid border-2 border-gray-600 mt-3 rounded addr2" style="width:400px" readonly>
					<input type="text" name="student_addr_sub" value="${vo.student_addr_sub}" class="addr_sub border-solid border-2 border-gray-600 mt-3 rounded" style="width:300px"placeholder="상세주소">
				</td>
			</tr>
			<tr>
		...
		<input type="hidden" name="student_no" value="${vo.student_no}"/>
			<div class="flex">
				<div class="inline-block relative w-40 mr-2">
					<select id="counseling_division" name="counseling_division" class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
						<option>::상담구분::</option>
						<option>입학상담</option>
						<option>일반상담</option>
						<option>휴퇴원상담</option>
				...
				<input type="text" name="counseling_title" id="counseling_title" class="border-solid border-2 border-gray-600" style="width:300px;"/>
			</div>
			<div class="w-full my-3">
				<textarea rows="5" cols="150" class="border-solid border-2 border-gray-600" name="counseling_content" id="counseling_content"></textarea>
			</div>
			<div class="my-2 flex justify-between">
				<span>- 상담일자는 금일자로 자동 추가됩니다.</span>
				<input type="submit" value="등록하기" id="counseling_regi" class="border-solid border-2 border-gray-600"/>
			</div>
		</form>
		...
		<div class="w-full my-3" style="display:none;" id="modify_colsed_out_form">
			...
			<table class="w-full">
				...
				<tr>
					...
					<td class="border-2 border-solid border-gray-600 p-2">
						<div class="calendar">
							<input type="text" name="student_course_state_date" class="datepicker border-solid border-2 border-gray-600 ml-2"/>
						</div>
					</td>
				</tr>
				<tr>
