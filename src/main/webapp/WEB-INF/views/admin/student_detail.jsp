...
<div class="w-full max-w-screen-xl my-0 mx-auto px-8 xl:px-0">
	...
	<div class="w-full bg-white p-4 border-l border-b border-r">
		...
		<input type="hidden" name="student_no" value="${vo.student_no}"/>
			<table class="w-full">
				...
				<tr>
					...
					<td class="border-solid border border-gray-600 p-2 ">
						<div class="inline-block relative w-40 mx-2">
							<select name="student_birthday_year" class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-2 py-1 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline birthYear">
								<option>선택</option>
						...
						년<div class="inline-block relative w-40 mx-2">
							<select name="student_birthday_month" class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-2 py-1 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline birthMonth">
								<option>선택</option>
						...
						월<div class="inline-block relative w-40 mx-2">
							<select name="student_birthday_day" class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-2 py-1 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline birthDay">
								<option>선택</option>
					...
					<td class="border-solid border border-gray-600 p-2 ">
						<div class="flex"> 
							...
							<div class="inline-block relative w-40">
								<select id="sDomainSelect" onclick="sInputDomain()" class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-2 py-1 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
									<option>직접입력</option>
				...
				<tr>
					...
					<td class="border-solid border border-gray-600 p-2 ">
						<div class="inline-block relative w-auto">
							<select name="student_house1" class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-2 py-1 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
				...
				<tr>
					...
					<td class="border-solid border border-gray-600 p-2 ">
						<div class="flex"> 
							...
							<div class="inline-block relative w-40">
								<select id="pDomainSelect" onclick="pInputDomain()" class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-2 py-1 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
									<option>직접입력</option>
				...
				<tr>
					...
					<td class="border-solid border border-gray-600 p-2 ">
						<div class="inline-block relative w-40 mx-2">
							<select name="student_parent_state" class="relation block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-2 py-1 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
								<option>==</option>
				...
				<tr>
					...
					<td  class="border-solid border border-gray-600 p-2 "colspan="3">
						<div class="flex">
							...
							<input type="button" onClick="openDaumZipAddress();" class="ml-3 rounded w-20 bg-gray-500 py-1 px-2" value="주소검색"/>
						</div>
			...
			<div class="my-5 flex justify-center">
				<input class="py-2 px-4 bg-info-700 text-white rounded mr-1" type="submit" value="수정하기" id="modify_studentInfo"/>
				<a href="javascript:memberDelete_check(${vo.student_no})" class="py-2 px-4 bg-info-700 text-white rounded">삭제하기</a>
			</div>
		</form>
		<!-- ----------------------------------------------기본정보 ---------------------------------------->
		<!------------------------------------------------- 상담관리 ------------------------------------------------>
			...
			<input type="hidden" name="student_no" value="${vo.student_no}"/>
				<div class="flex">
					<div class="inline-block relative w-40 mr-2">
						<select id="counseling_division" name="counseling_division" class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-2 py-1 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
							<option>::상담구분::</option>
							<option>입학상담</option>
							<option>일반상담</option>
							<option>휴퇴원상담</option>
		...
		<form id="modify_counseling_form" method="post" action="/lms/modify_counselingOk" style="display:none">
			...
			<div class="flex">
				<div class="inline-block relative w-40 mr-2">
					<select name="counseling_division" class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-2 py-1 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
						<option>입학상담</option>
						<option>일반상담</option>
						<option>휴퇴원상담</option>
						<option>학부모상담</option>
				...
				<table class="w-full">
					<tr>
						...
						<td class="border border-solid border-gray-600 p-2">
							<div class="inline-block relative w-40">
								<select name="course_day" id="course_day" class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-2 py-1 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
				 			...
				 			<div class="inline-block relative w-40"> 
								<select name="course_time" id="course_time" class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-2 py-1 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
							...
							<div class="inline-block relative w-40">
								<select name="course_stage" id="course_stage" class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-2 py-1 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline text-center">
	...
	<div class="w-full" id="attendance_absent" style="display:none">
		...
		<div class="w-full" id="attendance_absent" style="display:none">
			<div class="inline-block relative w-auto mr-2">
				<select id="attendanceKey" class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-2 py-1 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline month">
					<c:forEach var="vo5" items="${list4}">
