...
<div class="w-full bg-cover flex items-center" style="height:700px; background-image:url('<%=ctx%>/img/avel.jpg')">
	<div class="container my-0 mx-auto">
		...
		<p class="text-black post fadeUp"><span class="text-danger">EDUCAMP</span>항상 끊임없이 연구하고 노력하는<br>IT전문교육기관입니다.</p>
	</div>
</div>
<div class="container my-0 mx-auto ">
	<div class="mt-20">
		<span class="text-danger roboto-slab fadeUp">EduCamp 5 Principles</span>
		<div class="w-full mt-3 flex">
			<span class="text-xl w-1/2 fadeRight"><span class="roboto-slab">EduCamp</span>가 가르치는 방식</span>
			<span class="ml-24 w-1/2 fadeLeft"><span class="text-danger roboto-slab">EduCamp</span>는 서로를 지지하고 도전을 즐기는 기업문화 안에서 아래 5가지<br>원칙을 가지고 일합니다.</span>
		</div>
...
<div class="container my-0 mx-auto">
	<div class="mt-40">
		<span class="text-danger font-bold fadeUp">Brand Mission</span>
		<div class="w-full mt-3 flex">
			<span class="font-bold text-2xl w-1/2 fadeRight">올바른 생각이 신뢰를 바탕으로<br> 성장하는 세상을 만들고자 합니다</span>
			<div class="text-lg w-1/2 fadeLeft"><span class="text-danger">EduCamp</span> 업의 본질은 단순히 자금을 모으는 것이 아닙니다. 금융시장의 자금이 창업 기업이나 스타트업 등 꼭 필요한 곳에 흘러가도록 하여, 더욱 성장하는 세상을 만드는 것이 우리의 미션입니다.</div>
	    </div>
    </div>
</div>  
<hr class="my-40">
<div class="container my-0 mx-auto mb-40">
	<div>
		<span class="text-danger font-bold fadeUp">Brand Vision</span>
		<div class="w-full mt-3 flex">
			<span class="font-bold text-2xl w-1/2 fadeRight"><span class="text-danger">EduCamp</span>는 신뢰를 바탕으로<br>소통하며 협력하는<br>Trust Capitalist Group입니다</span>
			<div class="text-lg w-1/2 fadeLeft"><span class="text-danger">EduCamp</span> 업의 본질은 단순히 자금을 모으는 것이 아닙니다. 금융시장의 자금이 창업 기업이나 스타트업 등 꼭 필요한 곳에 흘러가도록 하여, 더욱 성장하는 세상을 만드는 것이 우리의 미션입니다.</div>
	    </div>
	 </div>
</div>