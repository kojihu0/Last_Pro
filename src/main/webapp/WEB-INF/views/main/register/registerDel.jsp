...
<form>
<div class="text-center">
	<input type="text" placeholder="ID" id="delId"  class="focus:bg-gray-200 focus:outline-none border-brand-500 border-2 px-1 py-1"/>
</div>
<div class="text-center mt-2">
	<input type="text"placeholder="PASSWORD" class="focus:bg-gray-200 focus:outline-none border-brand-500 border-2 px-1 py-1"/>
</div>
<div class="text-center mt-2">
