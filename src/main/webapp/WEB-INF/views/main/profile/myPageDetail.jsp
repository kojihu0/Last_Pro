      ...
      <table class="w-full">
         ...
         <tr>
          ...
          <tr>
            ...
            <td class="border-solid border-4 border-gray-600 " colspan="3">
            <div class="calendar"><input type="text" value="${info.grade}" name="student_regi_date" class="datepicker pointer-events-none border-solid border border-white ml-2 first_regiDate"/></div></td>
         </tr>
      </table>
		   </form>
				<!-- DivTable.com -->
