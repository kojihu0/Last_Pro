   ...
   <input type="hidden" name="student_no" value="${vo.student_no}"/>
      ...
      <table class="w-full">
         <tr>
            ...
            <td class="border-solid border-4 border-gray-600 p-2">
               <div class="overflow-y-auto" >
                  <div>
                     <span class="ml-3">${info.employee_name}</span>
                  </div>
               </div>
            </td>
            ...
            <td class="border-solid border-4 border-gray-600 p-2">
               <div class="overflow-y-auto" >
                  <div>
                     <span class="ml-3">${info.course_name}</span>
                  </div>
               </div>
            </td>
         </tr>
          <tr>
            ...
            <div class="calendar">
            <input type="text" value="${vo.student_name_ko}" name="student_regi_date" class="datepicker border-solid border-2 pointer-events-none border-gray-600 ml-2 first_regiDate"/>
            </div>
            </td>
         </tr>
         ...
         <tr>
            ...
            <td class="border-solid border-4 border-gray-600 p-2 ">
                <input type="text" name="student_phone_tel2" class="border-solid border-2 pointer-events-none border-gray-600 w-40  " value="${vo.student_tel_phone }"/>
            </td>
            <td class="border-solid border-4 text-white border-gray-600 bg-brand-500 p-2 text-center">Email</td>
            <td class="border-solid border-4 border-gray-600 p-2 ">
               <div> 
                  <input id="sEmail" type="text" name="student_email_id" class="pointer-events-none border-solid border-2 border-gray-600 " value="${vo.student_email}"/>
         ...
         <tr>
            ...
            <td class="border-solid border-4 border-gray-600 p-2 pointer-events-none"colspan="3"><textarea cols="100" rows="5" class="border-solid border-2 border-gray-600 pointer-events-none" name="student_memo">${vo.student_info}</textarea></td>
         </tr>
         
         <tr>
            <td class="border-solid border-4 text-white border-gray-600 bg-brand-500 p-2 text-center">수업시작일</td>
            <td class="border-solid border-4 border-gray-600  " colspan="3">
            <div class="calendar"><input type="text" value="${info.course_start_date}" name="student_regi_date" class="datepicker  pointer-events-none border-solid border-2 border-gray-600 ml-2 first_regiDate"/></div></td>
         </tr>
          <tr>
            <td class="border-solid border-4 text-white border-gray-600 bg-brand-500 p-2 text-center">수업종료일</td>
            <td class="border-solid border-4 border-gray-600  " colspan="3">
            <div class="calendar"><input type="text" value="${info.course_end_date}" name="student_regi_date" class="datepicker pointer-events-none border-solid border-2 border-gray-600 ml-2 first_regiDate"/></div></td>
         </tr>
          <tr>
            <td class="border-solid border-4 text-white border-gray-600 bg-brand-500 p-2 text-center">성적</td>
            <td class="border-solid border-4 border-gray-600 " colspan="3">
            <div class="calendar"><input type="text" value="${info.grade}" name="student_regi_date" class="datepicker pointer-events-none border-solid border-2 border-gray-600 ml-2 first_regiDate"/></div></td>
         </tr>
      </table>
		   </form>
				<!-- DivTable.com -->
