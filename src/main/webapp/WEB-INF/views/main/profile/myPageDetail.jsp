...
<div id="content" class="w-full my-0 mx-auto">
   ...
   <input type="hidden" name="student_no" value="${vo.student_no}"/>
      ...
      <table class="w-full">
         <tr>
            <td class="border-solid border text-white border-gray-600 bg-brand-500 p-2 text-center">강사명</td>
            ...
            <td class="border-solid border text-white border-gray-600 bg-brand-500 p-2 text-center">강좌명</td>
            <td class="border-solid border border-gray-600 p-2">
               <div class="overflow-y-auto" >
                  <div>
          ...
          <tr>
            <td class="border-solid border text-white border-gray-600 bg-brand-500 p-2 text-center">이름</td>
            <td class="border-solid border border-gray-600 " colspan="3">
            <div class="calendar">
         ...
         <tr>
            <td class="border-solid border text-white border-gray-600 bg-brand-500 p-2 text-center">휴대폰 번호</td>
            <td class="border-solid border border-gray-600 p-2 ">
            ...
            <td class="border-solid border text-white border-gray-600 bg-brand-500 p-2 text-center">Email</td>
            <td class="border-solid border border-gray-600 p-2 ">
               <div> 
         ...
         <tr>
            <td class="border-solid border text-white border-gray-600 bg-brand-500 p-2 text-center">수업시작일</td>
            <td class="border-solid border border-gray-600  " colspan="3">
          ...
          <tr>
            <td class="border-solid border text-white border-gray-600 bg-brand-500 p-2 text-center">수업종료일</td>
            <td class="border-solid border border-gray-600  " colspan="3">
