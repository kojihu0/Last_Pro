	...
	<div class="flex mt-12">
		...
		<div class="lg:w-4/5 w-full mt-4 pl-8">
			<ul class="flex roboto-slab">
			  ...
			  <li class="mr-1">
			    <a class="  bg-white hover:border-brand-500 border-b border-l border-t border-r py-3 px-4 text-gray-900 hover:text-brand-500 font-semibold" href="<%=ctx%>/schedule?no">Schedule</a>
			  </li>
			  <li class="mr-1">
